...
namespace Proto.Cluster.SingleRemoteInstance
{
    ...
    {
        const string KindsResponder = "remote_kinds_responder";
        ...
        private volatile string _clusterAddress;
        ...
        public string[] ClusterAddresses => new[] {_clusterAddress};
        ...
        private void NotifyStatuses()
        {
            ...
            _clusterAddress = status.Address;
